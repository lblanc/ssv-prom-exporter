...
- [ ] AC9: PSP 21 / 22 validation — confirm session-auth flow and perf endpoint shape on newer releases.
- [ ] AC10: Custom CA pool flag (operator can flip `-insecure` off in sites with internal PKI).
